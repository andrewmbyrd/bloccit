...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  # #13
  let(:my_spost) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price:1500) }
  ...
  describe"POST #create" do
    it "increases the number of Post by 1" do
      expect{post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price:1000}}.to change(SponsoredPost,:count).by(1)
    end


    it "assigns the new sponsored post to @sponsored_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price:1000}
  ...
  describe "PUT #update" do
    it "updates post with expected attributes" do
      ...
      put :update, topic_id: my_topic.id, id: my_spost.id, sponsored_post: {title: new_title, body: new_body, price: 3}
    ...
    it "redirects to the updated post" do
      ...
      put :update, topic_id: my_topic.id, id: my_spost.id, sponsored_post: {title: new_title, body: new_body, price: 5}
